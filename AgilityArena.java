...
@Manifest(authors = { "Anonim" }, name = "Agility Arena", description = "Gets tickets at the Agility Arena", version = 2.0)
public class JJsAgilityArena extends ActiveScript implements PaintListener {
	...
	public void onStop() {
		System.out.println("Agility Arena has been ended");
    ...
    public void onRepaint(Graphics g) {
		...
		g.drawString("Agility Arena v2.1", 5, 90);
